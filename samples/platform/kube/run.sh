...
new_app order v1 cluster01 "http://payment:8080,http://user:8080,http://reviews:8080,http://inventory:8080,"
new_app order v2 cluster01 "http://payment:8080,http://user:8080,http://reviews:8080,http://inventory:8080,"

new_app payment v1 cluster01 "http://user:8080,tcp://payment-db:8585"
new_app payment v2 cluster01 "http://user:8080,tcp://payment-db:8585"

new_app payment-db v1 cluster01 ""

new_app inventory v1 cluster01 "http://user:8080,grpc://product:7575,"

new_app reviews v1 cluster01 "http://user:8080,"
new_app reviews v2 cluster01 "http://user:8080,"
new_app reviews v3 cluster01 "http://user:8080,"

new_app recommendation v1 cluster01 "http://user:8080,"
